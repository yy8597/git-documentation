...
![Alt Text](http://git-scm.com/figures/18333fig0301-tn.png)

图 3-1. 单个提交对象在仓库中的数据结构

作些修改后再次提交，那么这次的提交对象会包含一个指向上次提交对象的指针（译注：即下图中的 parent 对象）。两次提交后，仓库历史会变成图 3-2 的样子：

![Alt Text](http://git-scm.com/figures/18333fig0302-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0303-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0304-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0305-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0306-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0307-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0308-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0309-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0310-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0311-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0312-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0313-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0314-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0315-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0316-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0317-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0318-tn.png)

图 3-18. 稳定分支总是比较老旧。

或者把它们想象成工作流水线，或许更好理解一些，经过测试的提交对象集合被遴选到更稳定的流水线（见图 3-19）。

![Alt Text](http://git-scm.com/figures/18333fig0319-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0320-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0321-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0322-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0323-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0324-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0325-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0326-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0327-tn.png)

图 3-27. 最初分叉的提交历史。

之前介绍过，最容易的整合分支的方法是 `merge` 命令，它会把两个分支最新的快照（C3 和 C4）以及二者最新的共同祖先（C2）进行三方合并，合并的结果是产生一个新的提交对象（C5）。如图 3-28 所示：

![Alt Text](http://git-scm.com/figures/18333fig0328-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0329-tn.png)

图 3-29. 把 C3 里产生的改变到 C4 上重演一遍。

现在回到 `master` 分支，进行一次快进合并（见图 3-30）：

![Alt Text](http://git-scm.com/figures/18333fig0330-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0331-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0332-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0333-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0334-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0335-tn.png)
...
![Alt Text](http://git-scm.com/figures/18333fig0339-tn.png)
